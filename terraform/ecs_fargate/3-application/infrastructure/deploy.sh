...
SERVICE_NAME="app"
SERVICE_TAG="v1"
ECR_REPO_URL="AMAZON_ACCOUNT_ID.dkr.ecr.us-east-1.amazonaws.com/${SERVICE_NAME}" # Please add your respective aws account id in place of AMAZON_ACCOUNT_ID before running this script

if [ "$1" = "dockerize" ];then
    sudo docker login -u AWS -p $(aws ecr get-login-password --region us-east-1) AMAZON_ACCOUNT_ID.dkr.ecr.us-east-1.amazonaws.com # Please add your respective aws account id in place of AMAZON_ACCOUNT_ID before running this script
